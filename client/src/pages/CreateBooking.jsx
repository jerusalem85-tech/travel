        ...
        {cat === 'other' && (
          <div className="row g-2 mb-2">
            <div className="col-md-6">
              ...
              <input className="form-control" placeholder="Service description" value={s.description} onChange={e => svc(i, 'description', e.target.value)} />
            </div>
          </div>
        )}
        {cat === 'hotel' && (
            ...
            {passengers.map((p, i) => (
              <div key={i} className="row g-2 mb-2">
                ...
                <div className="col-md-2">
                  ...
                  <select className="form-select" value={p.type} onChange={e => pax(i, 'type', e.target.value)}>
