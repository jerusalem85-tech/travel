...
router.get('/', async (req, res) => {
  ...
  const rows = await db.all(`SELECT v.*, c.full_name as customer_name FROM visas v LEFT JOIN customers c ON v.customer_id = c.id WHERE ${where} ORDER BY v.created_at DESC LIMIT ? OFFSET ?`, [...params, parseInt(limit), offset]);
