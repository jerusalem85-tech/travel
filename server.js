  ...
  try {
    ...
    if (airportCount.c === 0) {
      const airports = [
        ...
        ['IEV','Kyiv Boryspil Airport','Kyiv','Ukraine'],
        ['KBP','Kyiv Boryspil Airport','Kyiv','Ukraine'],
        ['DUS','Dusseldorf Airport','Dusseldorf','Germany'],
        ['TXL','Berlin Brandenburg Airport','Berlin','Germany'],
        ...
        ['CMB','Bandaranaike Airport','Colombo','Sri Lanka'],
        ['HKT','Phuket International Airport','Phuket','Thailand'],
        ['CNX','Chiang Mai Airport','Chiang Mai','Thailand'],
        ['USM','Koh Samui Airport','Koh Samui','Thailand'],
        ['REP','Siem Reap Airport','Siem Reap','Cambodia'],
        ['PNH','Phnom Penh Airport','Phnom Penh','Cambodia'],
        ['VTE','Wattay Airport','Vientiane','Laos'],
        ['RGN','Mandalay Airport','Mandalay','Myanmar'],
        ['KTM','Pokhara Airport','Pokhara','Nepal'],
        ['TBS','Batumi Airport','Batumi','Georgia'],
        ...
        ['PHL','Philadelphia Airport','Philadelphia','USA'],
        ...
        ['UIO','Mariscal Sucre Airport','Quito','Ecuador'],
        ['CCS','Simon Bolivar Airport','Caracas','Venezuela'],
        ['HAV','Jose Marti Airport','Havana','Cuba'],
        ['SJU','Luis Munoz Marin Airport','San Juan','Puerto Rico'],
        ['PUJ','Punta Cana Airport','Punta Cana','Dominican Republic'],
        ['MBJ','Sangster Airport','Montego Bay','Jamaica'],
        ['NAS','Lynden Pindling Airport','Nassau','Bahamas'],
        ['CPT','Cape Town International Airport','Cape Town','South Africa'],
        ['DUR','King Shaka Airport','Durban','South Africa'],
        ...
        ['DKR','Blaise Diagne Airport','Dakar','Senegal'],
        ...
        ['ELQ','Prince Naif bin Abdulaziz Airport','Qassim','Saudi Arabia'],
        ...
        ['NGO','Chubu Centrair Airport','Nagoya','Japan'],
        ...
        ['CMB','Bandaranaike Airport','Colombo','Sri Lanka'],
        ['HRI','Mattala Rajapaksa Airport','Hambantota','Sri Lanka'],
        ['DAC','Hazrat Shahjalal Airport','Dhaka','Bangladesh'],
        ['CGP','Shah Amanat Airport','Chittagong','Bangladesh'],
        ...
        ['TBU','Fuaamotu Airport','Nukualofa','Tonga'],
        ['OUA','Thomas Sankara Airport','Ouagadougou','Burkina Faso'],
        ['BKO','Modibo Keita Airport','Bamako','Mali'],
        ['NIM','Diori Hamani Airport','Niamey','Niger'],
        ['NDJ','Ndjamena Airport','Ndjamena','Chad'],
        ['FIH','Ndjili Airport','Kinshasa','DR Congo'],
        ['LUN','Kenneth Kaunda Airport','Lusaka','Zambia'],
        ['HRE','Robert Mugabe Airport','Harare','Zimbabwe'],
        ['GABS','Modibo Keita Airport','Bamako','Mali'],
        ['WDH','Hosea Kutako Airport','Windhoek','Namibia'],
        ['GABS','Bamako Airport','Bamako','Mali'],
        ['COO','Cadjehoun Airport','Cotonou','Benin'],
        ['LFW','Lome-Tokoin Airport','Lome','Togo'],
        ['BGF','Bangui Airport','Bangui','Central African Republic'],
        ['LBV','Leon Mba Airport','Libreville','Gabon'],
        ['FIH','Ndjili Airport','Kinshasa','DR Congo'],
        ['BZV','Maya-Maya Airport','Brazzaville','Congo'],
        ['FBM','Lubumbashi Airport','Lubumbashi','DR Congo'],
        ['GOM','Goma International Airport','Goma','DR Congo'],
        ...
        ['RUN','Roland Garros Airport','Saint-Denis','Reunion'],
        ['MRU','Sir Seewoosagur Ramgoolam Airport','Port Louis','Mauritius'],
        ...
        ['GBE','Sir Seretse Khama Airport','Gaborone','Botswana'],
        ['MPM','Maputo Airport','Maputo','Mozambique'],
        ['VFA','Victoria Falls Airport','Victoria Falls','Zimbabwe'],
        ['LVI','Harry Mwanga Nkumbula Airport','Livingstone','Zambia'],
        ['BBK','Kasane Airport','Kasane','Botswana'],
        ['MQP','Kruger Mpumalanga Airport','Nelspruit','South Africa'],
        ...
        ['WDH','Windhoek Airport','Windhoek','Namibia'],
      ];
    ...
    if (airlineCount.c === 0) {
      const airlines = [
        ...
        ['W5','Mahan Air','Iran'],
        ['QB','Qeshm Air','Iran'],
        ['ZV','Zagros Airlines','Iran'],
        ['I3','ATA Airlines','Iran'],
        ['T5','Turkmenistan Airlines','Turkmenistan'],
        ['YK','Avia Traffic Company','Kyrgyzstan'],
        ['QH','Air Kyrgyzstan','Kyrgyzstan'],
        ['SZ','Somon Air','Tajikistan'],
        ['7J','Tajik Air','Tajikistan'],
        ['HY','Uzbekistan Airways','Uzbekistan'],
        ['C7','Centrum Air','Uzbekistan'],
        ['HH','Qanot Sharq','Uzbekistan'],
        ...
        ['2A','Air Astra','Bangladesh'],
        ['BG','Biman Bangladesh Airlines','Bangladesh'],
        ['8D','FitsAir','Sri Lanka'],
        ['UL','SriLankan Airlines','Sri Lanka'],
        ['NR','Manta Air','Maldives'],
        ['Q2','Maldivian','Maldives'],
        ['RA','Nepal Airlines','Nepal'],
        ['YT','Yeti Airlines','Nepal'],
        ['U4','Buddha Air','Nepal'],
        ['KB','Druk Air','Bhutan'],
        ['B3','Bhutan Airlines','Bhutan'],
        ['VA','Virgin Australia','Australia'],
        ['ZL','Rex Airlines','Australia'],
        ['VA','Virgin Australia','Australia'],
        ['FC','FlyPelican','Australia'],
        ['QQ','Alliance Airlines','Australia'],
        ['NZ','Air New Zealand','New Zealand'],
        ['S8','Sounds Air','New Zealand'],
        ...
        ['QP','Akasa Air','India'],
        ['G8','Go First','India'],
        ['I5','AIX Connect','India'],
        ['9W','Jet Airways','India'],
        ['S2','JetKonnect','India'],
        ['9I','Alliance Air','India'],
        ['OG','Star Air','India'],
        ['LB','Air Costa','India'],
        ['ER','Air Seychelles Domestic','Seychelles'],
        ['7Z','Eswatini Air','Eswatini'],
        ['4Z','Airlink','South Africa'],
        ['FA','FlySafair','South Africa'],
        ['5Z','CemAir','South Africa'],
        ['GE','LIFT Airline','South Africa'],
        ['WU','Wizz Air Malta','Malta'],
        ['FR','Ryanair UK','UK'],
        ['RK','Ryanair Sun','Poland'],
        ['LW','Lauda Europe','Malta'],
        ['V7','Volotea','Spain'],
